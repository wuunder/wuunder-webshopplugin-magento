...
class Wuunder_WuunderConnector_Model_Carrier_Wuunderdpd extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        if (!Mage::getStoreConfig('carriers/' . $this->_code . '/active') || Mage::app()->getStore()->isAdmin() || !Mage::getSingleton('wuunderconnector/dpdwebservice')->getLoginResult() || $quote->getData('is_multi_shipping')) {
            return false;
        }
