<?php
/**
 * Class Wuunder_WuunderConnect_Block_Adminhtml_System_Config_Form_Dpd_Availability
 */
class Wuunder_WuunderConnect_Block_Adminhtml_System_Config_Form_Dpd_Availability extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function getAvailabilityHtml(){
        if($this->getParcelshopsAvailableForThisWebsite() != 0){
           return Mage::helper('wuunderconnector/data/dpd')->__("CSV Uploaded (%s shops). ", $this->getParcelshopsAvailableForThisWebsite());
        }
        else{
            return Mage::helper('wuunderconnector/data/dpd')->__("No CSV uploaded.");
        }
    }
