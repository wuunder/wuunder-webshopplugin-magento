...
DPD.Shipping = Class.create({
    initialize: function (container, config) {
        ...
        if (this.container.down('.parcelshoplogo')) {
            this.container.down('#s_method_wuunderdpd_wuunderdpd').checked = true;
    ...
    displayParcelsInline: function () {
        ...
        new parent.Ajax.Request(reloadurl, {
            ...
            onSuccess: function (data) {
                ...
                var priceContainer = this.container.down('label[for="s_method_wuunderdpd_wuunderdpd"] span');
        ...
        if (progressContents != undefined) {
            if (!$('s_method_wuunderdpd_wuunderdpd').checked && progressContents.up().next().innerHTML) {
